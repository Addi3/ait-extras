...
public class ExtrasMonitorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ExtrasMonitorBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ExtrasMonitorBlockEntity(pos, state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        if (blockEntity instanceof ExtrasMonitorBlockEntity monitorBlockEntity)
