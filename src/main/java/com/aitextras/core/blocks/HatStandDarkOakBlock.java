...
public class HatStandDarkOakBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public HatStandDarkOakBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new HatStandDarkOakBlockEntity(pos, state);
    }
