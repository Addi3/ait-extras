...
public class HatStandCrimsonBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public HatStandCrimsonBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new HatStandCrimsonBlockEntity(pos, state);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        ...
        tooltip.add(Text.translatable("block.tooltip.hatstandcrimson").formatted(Formatting.GOLD));
