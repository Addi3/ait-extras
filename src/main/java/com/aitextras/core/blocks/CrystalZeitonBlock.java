...
public class CrystalZeitonBlock extends Block implements BlockEntityProvider {

    public static final BooleanProperty POWERED = BooleanProperty.of("powered");

    public CrystalZeitonBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return AITExtrasBlockEntityTypes.CRYSTAL_ZEITON_BLOCK.instantiate(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world, @NotNull BlockState state,
        ...
        return (world1, blockPos, blockState, ticker) -> {
            if (ticker instanceof CrystalZeitonBlockEntity be) {
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos,
        ...
        if (world.getBlockEntity(pos) instanceof CrystalZeitonBlockEntity be) {
