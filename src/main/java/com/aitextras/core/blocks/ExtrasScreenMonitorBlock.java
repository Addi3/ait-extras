...
public class ExtrasScreenMonitorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ExtrasScreenMonitorBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ExtrasScreenMonitorBlockEntity(pos, state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        if (blockEntity instanceof ExtrasScreenMonitorBlockEntity monitorBlockEntity)
