...
public class HatStandMangroveBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public HatStandMangroveBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new HatStandMangroveBlockEntity(pos, state);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        ...
        tooltip.add(Text.translatable("block.tooltip.hatstandmangrove").formatted(Formatting.GOLD));
