...
import com.aitextras.core.blockentities.StoneRoundelDoorBlockEntity;
...
public class StoneRoundelDoorBlock extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final BooleanProperty OPEN = BooleanProperty.of("open");
    public static final BooleanProperty CENTERED = BooleanProperty.of("centered");
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public StoneRoundelDoorBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return AITExtrasBlockEntityTypes.STONE_ROUNDEL_DOOR_BLOCK_ENTITY_TYPE.instantiate(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world, @NotNull BlockState state,
        ...
        return (world1, blockPos, blockState, ticker) -> {
            if (ticker instanceof StoneRoundelDoorBlockEntity be) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (world.getBlockEntity(pos) instanceof StoneRoundelDoorBlockEntity be) {

            if (!world.isClient) {
                boolean isOpen = state.get(StoneRoundelDoorBlock.OPEN);
                world.setBlockState(pos, state.with(StoneRoundelDoorBlock.OPEN, !isOpen), Block.NOTIFY_ALL);

                world.playSound(
                        null,
                        pos,
                        AITExtrasSounds.STONE_ROUNDEL_DOOR,
