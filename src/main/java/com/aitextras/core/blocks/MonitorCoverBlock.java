...
public class MonitorCoverBlock extends Block implements BlockEntityProvider {
    ...
    public MonitorCoverBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return AITExtrasBlockEntityTypes.MONITOR_COVER_BLOCK_ENTITY_TYPE.instantiate(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world, @NotNull BlockState state,
        ...
        return (world1, blockPos, blockState, ticker) -> {
            if (ticker instanceof MonitorCoverBlockEntity be) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (world.getBlockEntity(pos) instanceof MonitorCoverBlockEntity be) {
            ...
            if (!world.isClient) {
                boolean isOpen = state.get(MonitorCoverBlock.OPEN);
                world.setBlockState(pos, state.with(MonitorCoverBlock.OPEN, !isOpen), Block.NOTIFY_ALL);
