...
public class MonitorCoverRenderer<T extends BlockEntity & AnimatedBlockEntity> implements BlockEntityRenderer<T> {
    protected BedrockEntityModel model;

    public MonitorCoverRenderer() {}

    public MonitorCoverRenderer(BlockEntityRendererFactory.Context context) {
        this();
    }
