...
public class StoneRoundelDoorRenderer<T extends BlockEntity & AnimatedBlockEntity> implements BlockEntityRenderer<T> {
    protected BedrockEntityModel model;

    public StoneRoundelDoorRenderer() {}

    public StoneRoundelDoorRenderer(BlockEntityRendererFactory.Context context) {
        this();
    }
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (!(blockState.getBlock() instanceof StoneRoundelDoorBlock)) {
            return;
        }

        Direction direction = blockState.get(StoneRoundelDoorBlock.FACING);
        ...
        light = LightmapTextureManager.pack(8, 15);
