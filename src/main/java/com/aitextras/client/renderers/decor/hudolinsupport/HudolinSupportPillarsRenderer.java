...
public class HudolinSupportPillarsRenderer<T extends HudolinSupportPillarsBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public HudolinSupportPillarsRenderer(BlockEntityRendererFactory.Context ctx) {
