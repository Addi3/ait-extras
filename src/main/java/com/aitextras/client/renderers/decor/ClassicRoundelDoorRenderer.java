...
public class ClassicRoundelDoorRenderer<T extends BlockEntity & AnimatedBlockEntity> implements BlockEntityRenderer<T> {
    protected BedrockEntityModel model;

    public ClassicRoundelDoorRenderer() {}

    public ClassicRoundelDoorRenderer(BlockEntityRendererFactory.Context context) {
        this();
    }
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (!(blockState.getBlock() instanceof ClassicRoundelDoorBlock)) {
            return;
        }

        Direction direction = blockState.get(ClassicRoundelDoorBlock.FACING);
