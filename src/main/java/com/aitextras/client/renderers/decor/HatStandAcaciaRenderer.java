...
public class HatStandAcaciaRenderer<T extends HatStandAcaciaBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public HatStandAcaciaRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        this.hatStandModel.render(matrices,
                vertexConsumers.getBuffer(RenderLayer.getEntityTranslucent(HAT_STAND_ACACIA_TEXTURE)), light, overlay, 1.0F,
                1.0F, 1.0F, 1.0F);
