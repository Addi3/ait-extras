...
public class HatStandCherryRenderer<T extends HatStandCherryBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public HatStandCherryRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        this.hatStandModel.render(matrices,
                vertexConsumers.getBuffer(RenderLayer.getEntityTranslucent(HAT_STAND_CHERRY_TEXTURE)), light, overlay, 1.0F,
                1.0F, 1.0F, 1.0F);
