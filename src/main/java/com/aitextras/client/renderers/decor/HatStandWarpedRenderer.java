...
public class HatStandWarpedRenderer<T extends HatStandWarpedBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public HatStandWarpedRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        this.hatStandModel.render(matrices,
                vertexConsumers.getBuffer(RenderLayer.getEntityTranslucent(HAT_STAND_WARPED_TEXTURE)), light, overlay, 1.0F,
                1.0F, 1.0F, 1.0F);
